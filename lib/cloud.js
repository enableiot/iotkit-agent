...
function IoTKitCloud(conf, logger, deviceId){
  ...
  // @TODO: add subscribe implementation on the client 
  //        pass in callback to abstract users from message format complexities 
  //me.client.subscribe('topic', {qos: 1}, function(err, message))
...
IoTKitCloud.prototype.send = function(doc){
  ...
  // Setup base message
  // @TODO: move this outside of send
  //        will allow send to generic publish abstraction 
  var msg = {
